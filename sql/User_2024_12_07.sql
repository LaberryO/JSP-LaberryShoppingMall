...
create table board( -- 2024-12-07 추가됨.
    boardId number generated always as identity primary key,
    userId varchar2(20) not null,
    userName varchar2(10) not null,
    boardDate date not null,
    boardSubject varchar2(50) not null,
    boardMessage varchar2(3000) not null,
    constraint writeId foreign key (userId) references member(userId)
);
...
insert into member values ('admin', 'aDmin2134', '관리자', null, null, null, 'admin@homepage.kr', sysdate);
